...
@section('content')
      ...
      <div class="inner-banner-header wf100">
        <h1 data-generated="{{ __('Ficha de Equipo') }}">{{ __('Ficha de Equipo') }}</h1>
              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="player-card">
                    <div class="pimg">
                      @if($team->Escudo)
                      <img class="resize_escudo_center" src="{{ url('/') }}/images/teams/{{$team->Escudo}}" alt="{{$team->Nombre}}">
                      @else
                      <img class="resize_escudo_center" src="{{ url('/') }}/images/team.webp" alt="">
                      @endif
                    ...
                    <div class="player-details">
                      ...
                      @endforeach
                      <span class="follow"><a href="#">{{ __('Temporada') }} 25-26</a></span>
                      <ul>
