              ...
              <div class="row">
                ...
                <div class="col-lg-8">
                  ...
                  <div class="player-card">
                    <div class="pimg">
                      @if($team->Escudo)
                      <img class="resize_escudo_center" src="../images/teams/{{$team->Escudo}}" alt="{{$team->Nombre}}">
                      @else
                    ...
                    <div class="player-details">
                      ...
                      <ul>
                        <li> {{ __('Entrenador') }} <strong><a href="../entrenador/{{$team->Id}}">{{$team->Entrenador}}</a></strong></li>
